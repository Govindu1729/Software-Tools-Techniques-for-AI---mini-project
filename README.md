...
Implemented Deliverables
    ...
    train.ipynb performs label encoding, 5-fold cross-validation, hyperparameter search, trackio logging, plot generation, final retraining, and artifact export.
    app.py loads the saved model plus encoders with pickle.load and renders widget inputs for every feature.
    Dockerfile packages the Streamlit app on port 8501.
